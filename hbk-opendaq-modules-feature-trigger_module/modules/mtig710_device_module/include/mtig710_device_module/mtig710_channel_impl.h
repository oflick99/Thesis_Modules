...
DECLARE_OPENDAQ_INTERFACE(IMtig710Channel, IBaseObject)
{
...
class Mtig710ChannelImpl final : public ChannelImpl<IMtig710Channel>
{
public:
    explicit Mtig710ChannelImpl(const ContextPtr& ctx, const ComponentPtr& parent, const StringPtr& localId);
    ~Mtig710ChannelImpl() override;
