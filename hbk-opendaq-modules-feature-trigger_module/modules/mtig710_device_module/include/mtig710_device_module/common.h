...
#define BEGIN_NAMESPACE_MTIG710_DEVICE_MODULE BEGIN_NAMESPACE_OPENDAQ_MODULE(mtig710_device_module)
#define END_NAMESPACE_MTIG710_DEVICE_MODULE END_NAMESPACE_OPENDAQ_MODULE
