...
#define BEGIN_NAMESPACE_CAMERA_DEVICE_MODULE BEGIN_NAMESPACE_OPENDAQ_MODULE(camera_device_module)
#define END_NAMESPACE_CAMERA_DEVICE_MODULE END_NAMESPACE_OPENDAQ_MODULE
